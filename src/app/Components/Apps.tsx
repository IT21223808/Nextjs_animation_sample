        ...
        <div className='relative z-10 w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-20 grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-24 lg:gap-x-40'>
            <div className='flex flex-col items-center gap-8'>
                ...
                <div className='flex w-full justify-around md:justify-between'>
                    ...
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/deno.png' alt='deno' width={114} height={102}/>
                    ...
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/chrome.webp' alt='chrome' width={114} height={102}/>
                </div>
            </div>
            <div className='flex flex-col items-center gap-8'>
                <p className='text-white'>And with everything:</p>
                <div className='flex w-full justify-around md:justify-between'>
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/react.webp' alt='react' width={114} height={102}/>
                    ...
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/vite.webp' alt='vite' width={114} height={102}/>
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/next.png' alt='next' width={114} height={102}/>
                    <Image className='h-10 w-auto sm:h-12 saturate-0 hover:saturate-100 transition-all duration-300 cursor-pointer' src='/logo-5.png' alt='logo-5' width={114} height={102}/>
                </div>
            </div>
        </div>
