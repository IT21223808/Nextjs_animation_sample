            ...
            <div>
                <motion.div variants={wrapper} initial='hidden' whileInView='visible' viewport={{once:true}} className='h-28 flex justify-between'>
                    <motion.div variants={item} className='h-full flex items-center'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person17.jpg' alt='person-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className=' h-full flex items-start'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person2.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className=' h-full flex items-end'>
                        <div className='relative h-16 sm:h-20 w-16 sm:w-20'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person3.png' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-end'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person4.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-start'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person19.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full  items-end'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person6.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-start'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person15.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='hidden sm:flex h-full items-center'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person5.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                </motion.div>
                <motion.div variants={wrapper} initial='hidden' whileInView='visible' viewport={{once:true}} className='sm:hidden h-28 flex justify-between'>
                    <motion.div variants={item} className='h-full flex items-end'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person9.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='h-full flex items-start'>
                    ...
                    <motion.div variants={item} className='h-full flex items-start'>
                        <div className='relative h-14 w-14'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person18.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div variants={item} className='h-full flex items-center'>
                        <div className='relative h-8 w-8'>
                            <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                <Image src='/person12.jpg' alt='Cont-Image' width={100} height={100}/>
                            </div>
                        </div>
                    </motion.div>
                </motion.div>
                    ...
                    <div className='grow sm:w-1/3 lg:w-2/5'>
                        <motion.div initial='hidden' whileInView='visible' viewport={{once:true}} variants={wrapper} className='flex justify-around h-24'>
                            ...
                            <motion.div variants={item} className=' h-full flex items-end'>
                                <div className='relative h-8 w-8'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/person16.jpg' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-center'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/person10.jpg' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
                    ...
                    <div className='grow sm:w-1/3 lg:w-2/5'>
                        <motion.div initial='hidden' whileInView='visible' viewport={{once:true}} variants={wrapper} className='flex justify-around h-24'>
                            <motion.div variants={item} className=' h-full flex items-start'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/person8.jpg' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-end'>
                                <div className='relative h-8 w-8'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/person1.jpg' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                            <motion.div variants={item} className=' h-full flex items-center'>
                                <div className='relative h-14 w-14'>
                                    <div className='relative w-full h-full overflow-hidden rounded-full border border-white shadow-lg'>
                                        <Image src='/person14.jpg' alt='Cont-Image' width={100} height={100}/>
                                    </div>
                                </div>
                            </motion.div>
                        </motion.div>
